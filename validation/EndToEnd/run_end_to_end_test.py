...
sample = {
    ...
    "SensorGPS": {"latitude": 52.3600, "longitude": 4.8850, "altitude_m": 2.0},
    "SourceGPS": {"latitude": 52.3610, "longitude": 4.8860},
}
...
check(
    event["PIML_Runtime"]["correction_dispersion_piml"]["corrected_map_shape"]
    == [500, 500],
    "Corrected map shape is 500x500",
)
