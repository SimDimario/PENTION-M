...
\begin{itemize}
    ...
    \item \textbf{Integrare modelli \textit{Physic-Informed Machine Learning} (PIML)} per la correzione e l’interpretazione delle mappe di dispersione, garantendo coerenza con i vincoli fisici del dominio operativo.
